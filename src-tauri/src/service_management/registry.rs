...
pub const SERVICE_DESCRIPTORS: &[StaticServiceDescriptor] = &[
    ...
    StaticServiceDescriptor {
        ...
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["rest-api", "resource", "method", "stage"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "apigatewayv2",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["api", "route", "integration", "stage"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "elbv2",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["load-balancer", "listener", "target-group"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "route53",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["hosted-zone", "record-set", "health-check"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "transfer",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["server", "user", "workflow"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "cloudwatchlogs",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["log-group", "log-stream", "query"],
        safe_operations: &[],
    },
    StaticServiceDescriptor {
        key: "cloudwatch",
        ...
        domain_epic: "Network, observability, and edge",
        support_level: ServiceSupportLevel::Unsupported,
        primary_resource_kinds: &["metric", "alarm", "dashboard"],
        safe_operations: &[],
    },
];

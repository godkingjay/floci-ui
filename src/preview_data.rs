...
pub(crate) fn preview_service_catalog() -> serde_json::Value {
    json!({
...
pub(crate) fn browser_preview_inventory(
...
pub(crate) fn browser_preview_resource_detail(
    args: Option<&serde_json::Value>,
) -> Option<serde_json::Value> {
    let service_key = preview_request_value(args, "service_key")?;
...
pub(crate) fn browser_preview_action(
    args: Option<&serde_json::Value>,
) -> Option<serde_json::Value> {
